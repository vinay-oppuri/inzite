...
import { Bot, Network, FileText, Layers, BookText, Brain, MessageSquare, Sparkles } from 'lucide-react';
...
export default function WorkflowView() {
  return (
    <div className="flex-1 p-2 sm:px-10 sm:py-8 text-foreground space-y-10 max-w-7xl mx-auto w-full">
      ...
      <div className="md:text-center md:p-6 rounded-2xl md:bg-secondary/20 md:border border-border/50 mt-12 backdrop-blur-sm">
        <p className="text-xs md:text-sm text-muted-foreground font-medium flex items-start md:items-center justify-center gap-2">
